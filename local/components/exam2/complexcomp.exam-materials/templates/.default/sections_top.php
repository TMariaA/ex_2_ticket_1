...
if ($arParams["SEF_MODE"] =="Y"){
    $eurl = $arParams["SEF_FOLDER"].str_replace('#PARAM1#',$param1,$arParams["SEF_URL_TEMPLATES"]["exampage"])."?PARAM2=$param2";
}else{
    $eurl = $APPLICATION->GetCurPage()."?PARAM1=$param1&PARAM2=$param2";
}
?>
<?=GetMessage("EXAM_TEXT_LINK_CP_PHOTO")?> <a href="<?=$eurl?>"><?=$eurl?></a>
